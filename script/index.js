...
const cardData = [
    ...
    card.innerHTML = `
      <div class="card">
        ...
        <div class="card-body">
          ...
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" data-modal-id="${data.id}">Lihat</button>
        </div>
      </div>
    `;
    return card;
  ...
  function openModal(id) {
    ...
    if (selectedCard) {
      const modalTitle = document.getElementById("modalTitle");
      const modalBody = document.querySelector(".modal-body");
      modalTitle.innerHTML = selectedCard.title;
      modalBody.innerHTML = selectedCard.modalContent;
      $('#myModal').modal('show');
    }
  }
